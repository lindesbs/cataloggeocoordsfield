...
// Palettes
$GLOBALS['TL_DCA']['tl_catalog_fields']['palettes']['geocoordsfield'] = 'name,description,colName,type;{areaGeoCoords},itemTable,'.
				'geocoords_streetfield,geocoords_streetfield_rewrite,'.
				'geocoords_postalfield,geocoords_postalfield_rewrite,'.
				'geocoords_cityfield, geocoords_cityfield_rewrite,'.
				'geocoords_countryfield,geocoords_countryfield_rewrite';
...
$GLOBALS['TL_DCA']['tl_catalog_fields']['fields']['geocoords_streetfield_rewrite'] = array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_catalog_fields']['geocoords_streetfield_rewrite'],
			'inputType'               => 'checkbox',
...
$GLOBALS['TL_DCA']['tl_catalog_fields']['fields']['geocoords_postalfield_rewrite'] = array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_catalog_fields']['geocoords_postalfield_rewrite'],
			'inputType'               => 'checkbox',
			'eval'                    => array('tl_class'=>'w50 m12'),
		);
...
$GLOBALS['TL_DCA']['tl_catalog_fields']['fields']['geocoords_cityfield_rewrite'] = array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_catalog_fields']['geocoords_cityfield_rewrite'],
			'inputType'               => 'checkbox',
			'eval'                    => array('tl_class'=>'w50 m12'),
		);
...
$GLOBALS['TL_DCA']['tl_catalog_fields']['fields']['geocoords_countryfield_rewrite'] = array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_catalog_fields']['geocoords_countryfield_rewrite'],
			'inputType'               => 'checkbox',
			'eval'                    => array('tl_class'=>'w50 m12'),
		);
